  ...
  return (
    <div className="max-w-4xl mx-auto p-4 space-y-12">
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Usage</h2>
        <div className="flex flex-col gap-20">
          ...
          <div className="flex flex-col gap-10">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Animated Card</h2>
