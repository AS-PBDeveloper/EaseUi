  ...
  return (
    <div className="max-w-4xl mx-auto p-4 space-y-12">
      ...
      <section className="space-y-4 flex flex-col gap-10">
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Examples</h2>

        <div className="space-y-2">
          <h3 className="text-lg font-medium text-gray-800 dark:text-gray-200">Normal</h3>
        ...
        <div className="space-y-2">
          <h3 className="text-lg font-medium text-gray-800 dark:text-gray-200">Variants & Types</h3>
      ...
      <section className="space-y-2">
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">API Reference</h2>
