...
const cardVariants = cva(
  "rounded-lg transition-all duration-300 cursor-pointer overflow-hidden",
  {
    variants: {
      variant: {
        light: "bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 shadow-md hover:shadow-xl border border-gray-100 dark:border-gray-800",
        dark: "bg-slate-900 text-white shadow-md hover:shadow-lg border border-slate-800",
        outline:
          "border border-gray-300 dark:border-gray-700 bg-transparent text-gray-800 dark:text-gray-100",
      },
      // hoverEffect: {
      //   none: "",
