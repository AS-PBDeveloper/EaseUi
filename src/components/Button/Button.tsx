...
const buttonVariants = cva(
  `inline-flex items-center cursor-pointer justify-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50`,
  {
    variants: {
      variant: {
        dark: "bg-slate-900 hover:bg-slate-800 text-white dark:bg-slate-100 dark:hover:bg-white dark:text-slate-900 shadow-sm",
        primary: "bg-indigo-600 hover:bg-indigo-700 text-white shadow-sm",
        secondary: "bg-indigo-500 hover:bg-indigo-600 text-white shadow-sm",
        destructive: "bg-red-600 text-white hover:bg-red-700 shadow-sm",
        ok: "bg-emerald-600 hover:bg-emerald-700 text-white shadow-sm",
        ...
        outline:
          "bg-transparent hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-200 border border-gray-300 dark:border-gray-700 shadow-xs",
      },
      size: {
        default: "px-9 py-3",
        sm: "px-4 py-2",
